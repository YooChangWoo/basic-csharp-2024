...
using System.ComponentModel;  // 스레드 클래스 사용등록
...
namespace ex18_winControlApp
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            InitializeComponent();  // 디자이너에서 정의한 호면 구성 초기화
        ...
        private void BtnModal_Click(object sender, EventArgs e)
        {
            ...
            FrmModal.StartPosition = FormStartPosition.CenterParent;  // 정 중앙에 나오도록 설정
        ...
        private void BtnModaless_Click(object sender, EventArgs e)
        {
            ...
            // 모달리스창을 부모 정중앙에 위치할 떄는 아래와 같이 작업해야하 함
        ...
        private void BtnFileLoad_Click(object sender, EventArgs e)
        {
            ...
            dialog.Multiselect = false;   // 여러개 파일 금지
