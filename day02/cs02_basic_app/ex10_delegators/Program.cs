...
namespace ex10_delegators
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            notifier.EventOccured -= listener2.SomethingHappened; // 리스너 2번의 함수는 실행시키지마
            ...
            notifier.EventOccured("미사일 발사"); // 2, 3번 실행
            ...
            Callback = new MyDelegate(calc.Plus); //  int a, int b 가 아닌 calculator객체의 Plus() 메서드를 전달
