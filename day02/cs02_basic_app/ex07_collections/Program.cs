...
namespace ex07_collections
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] score = new int[5] { 70, 80, 90, 34, 55};
            // 3. 초기화 배열의 크기를 생략
            ...
            arrayList.RemoveAt(1);   // ArrayList 에서 인덱스 1번의 값을 삭제
            arrayList.Insert(2, 25);   // 2번 인덱스에 25를 추가

            // Stack, Quese Python 자료구조에 배웠던 스ㅐㄱ, 큐랑 차이없음
    ...
    class CustomEnumerator
    {
        ...
        public IEnumerator GetEnumerator()
        {
            ...
            // yield return은 return문을 실행한 뒤 멈춰있음. 다음 yield return문을 싱행하기 전까지
